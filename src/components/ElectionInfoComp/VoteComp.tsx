...
import AddVoteComp from "../AddVoteComp/AddVoteComp";

// import AddVoteComp from '../components/AddVoteComp/AddVoteComp';
const VoteComp: React.FC = () => {
  ...
  const [isOpenAddVoteComp, setIsOpenAddVoteComp] = useState(false);
    ...
    <div className="bg-[#9BA4B5] h-screen">
      ...
      <div className="flex justify-center mt-10">
        ...
        <div className="flex flex-col space-y-4 my-10 p-4">
          ...
          <div>
            <button
            onClick={() => setIsOpenAddVoteComp(true)}
              type="submit"
            ...
            {isOpenAddVoteComp && <AddVoteComp isOpen={isOpenAddVoteComp} setIsOpen={setIsOpenAddVoteComp} />}
          </div>
